...
{
  new (message_memory) ur_robotiq::msg::UR3eMoveitJoints(_init);
}

void UR3eMoveitJoints_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ur_robotiq::msg::UR3eMoveitJoints *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember UR3eMoveitJoints_message_member_array[2] = {
  {
    ...
    offsetof(ur_robotiq::msg::UR3eMoveitJoints, joints),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ur_robotiq::msg::UR3eMoveitJoints, pick_pose),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers UR3eMoveitJoints_message_members = {
  ...
  2,  // number of fields
  sizeof(ur_robotiq::msg::UR3eMoveitJoints),
...
get_message_type_support_handle<ur_robotiq::msg::UR3eMoveitJoints>()
{
  return &::ur_robotiq::msg::rosidl_typesupport_introspection_cpp::UR3eMoveitJoints_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ur_robotiq, msg, UR3eMoveitJoints)() {
  return &::ur_robotiq::msg::rosidl_typesupport_introspection_cpp::UR3eMoveitJoints_message_type_support_handle;
}
