...
static const _UrMoverService_Request_type_support_symbol_names_t _UrMoverService_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ur_robotiq, srv, UrMoverService_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ur_robotiq, srv, UrMoverService_Request)),
  }
};
...
{
  return &::ur_robotiq::srv::rosidl_typesupport_cpp::UrMoverService_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ur_robotiq, srv, UrMoverService_Request)() {
  return get_message_type_support_handle<ur_robotiq::srv::UrMoverService_Request>();
}
...
static const _UrMoverService_Response_type_support_symbol_names_t _UrMoverService_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ur_robotiq, srv, UrMoverService_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ur_robotiq, srv, UrMoverService_Response)),
  }
};
...
{
  return &::ur_robotiq::srv::rosidl_typesupport_cpp::UrMoverService_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ur_robotiq, srv, UrMoverService_Response)() {
  return get_message_type_support_handle<ur_robotiq::srv::UrMoverService_Response>();
}
...
static const _UrMoverService_type_support_symbol_names_t _UrMoverService_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ur_robotiq, srv, UrMoverService)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ur_robotiq, srv, UrMoverService)),
  }
};
...
{
  return &::ur_robotiq::srv::rosidl_typesupport_cpp::UrMoverService_service_type_support_handle;
}
