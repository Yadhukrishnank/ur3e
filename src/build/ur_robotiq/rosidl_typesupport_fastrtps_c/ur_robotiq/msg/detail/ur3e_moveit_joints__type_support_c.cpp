...
#include "ur_robotiq/msg/detail/ur3e_moveit_joints__rosidl_typesupport_fastrtps_c.h"
...
using _UR3eMoveitJoints__ros_msg_type = ur_robotiq__msg__UR3eMoveitJoints;
...
static uint32_t _UR3eMoveitJoints__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ur_robotiq__msg__UR3eMoveitJoints(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ur_robotiq__msg__UR3eMoveitJoints;
    is_plain =
      (
...
static size_t _UR3eMoveitJoints__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ur_robotiq__msg__UR3eMoveitJoints(
