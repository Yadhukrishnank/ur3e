...
#include "ur_robotiq/srv/detail/ur_mover_service__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const ur_robotiq::msg::UR3eMoveitJoints &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ur_robotiq::msg::UR3eMoveitJoints &);
...
{
  // Member: joints_input
  ur_robotiq::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
{
  // Member: joints_input
  ur_robotiq::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment +=
    ur_robotiq::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: joints_input
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ur_robotiq::msg::typesupport_fastrtps_cpp::max_serialized_size_UR3eMoveitJoints(
  ...
  if (is_plain) {
    ...
    using DataType = ur_robotiq::srv::UrMoverService_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ur_robotiq::srv::UrMoverService_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ur_robotiq::srv::UrMoverService_Request *>(
    untyped_ros_message);
...
{
  return &ur_robotiq::srv::typesupport_fastrtps_cpp::_UrMoverService_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ur_robotiq::srv::UrMoverService_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ur_robotiq::srv::UrMoverService_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ur_robotiq::srv::UrMoverService_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ur_robotiq::srv::typesupport_fastrtps_cpp::_UrMoverService_Response__handle;
}
...
{
  return &ur_robotiq::srv::typesupport_fastrtps_cpp::_UrMoverService__handle;
}
