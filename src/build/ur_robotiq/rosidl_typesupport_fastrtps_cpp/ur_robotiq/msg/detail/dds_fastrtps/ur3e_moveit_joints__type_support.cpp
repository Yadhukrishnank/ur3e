...
#include "ur_robotiq/msg/detail/ur3e_moveit_joints__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ur_robotiq::msg::UR3eMoveitJoints & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ur_robotiq::msg::UR3eMoveitJoints & ros_message)
{
  // Member: joints
  {
    cdr >> ros_message.joints;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ur_robotiq::msg::UR3eMoveitJoints;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ur_robotiq::msg::UR3eMoveitJoints *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ur_robotiq::msg::UR3eMoveitJoints *>(
    untyped_ros_message);
...
{
  return &ur_robotiq::msg::typesupport_fastrtps_cpp::_UR3eMoveitJoints__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ur_robotiq, msg, UR3eMoveitJoints)() {
  return &ur_robotiq::msg::typesupport_fastrtps_cpp::_UR3eMoveitJoints__handle;
}
