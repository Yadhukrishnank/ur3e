...
#include "ur_robotiq/msg/detail/ur3e_trajectory__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ur_robotiq::msg::UR3eTrajectory;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ur_robotiq::msg::UR3eTrajectory *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ur_robotiq::msg::UR3eTrajectory *>(
    untyped_ros_message);
...
{
  return &ur_robotiq::msg::typesupport_fastrtps_cpp::_UR3eTrajectory__handle;
}
