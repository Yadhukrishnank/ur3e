...
static const _UR3eGripper_type_support_symbol_names_t _UR3eGripper_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, unity_ros_msgs, msg, UR3eGripper)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, unity_ros_msgs, msg, UR3eGripper)),
  }
};
...
get_message_type_support_handle<unity_ros_msgs::msg::UR3eGripper>()
{
  return &::unity_ros_msgs::msg::rosidl_typesupport_cpp::UR3eGripper_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, unity_ros_msgs, msg, UR3eGripper)() {
  return get_message_type_support_handle<unity_ros_msgs::msg::UR3eGripper>();
}
