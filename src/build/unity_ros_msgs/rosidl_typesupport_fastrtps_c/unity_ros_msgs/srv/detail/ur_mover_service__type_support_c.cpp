...
#include "unity_ros_msgs/srv/detail/ur_mover_service__rosidl_typesupport_fastrtps_c.h"
...
#include "unity_ros_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
#include "unity_ros_msgs/msg/detail/ur3e_moveit_joints__functions.h"  // joints_input
...
size_t get_serialized_size_unity_ros_msgs__msg__UR3eMoveitJoints(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_unity_ros_msgs__msg__UR3eMoveitJoints(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, unity_ros_msgs, msg, UR3eMoveitJoints)();


using _UrMoverService_Request__ros_msg_type = unity_ros_msgs__srv__UrMoverService_Request;
  ...
  // Field name: joints_input
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, unity_ros_msgs, msg, UR3eMoveitJoints
      )()->data);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_unity_ros_msgs
size_t get_serialized_size_unity_ros_msgs__srv__UrMoverService_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _UrMoverService_Request__ros_msg_type * ros_message = static_cast<const _UrMoverService_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_unity_ros_msgs__msg__UR3eMoveitJoints(
...
static uint32_t _UrMoverService_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_unity_ros_msgs__srv__UrMoverService_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_unity_ros_msgs
size_t max_serialized_size_unity_ros_msgs__srv__UrMoverService_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: joints_input
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_unity_ros_msgs__msg__UR3eMoveitJoints(
  ...
  if (is_plain) {
    ...
    using DataType = unity_ros_msgs__srv__UrMoverService_Request;
    is_plain =
      (
...
static size_t _UrMoverService_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_unity_ros_msgs__srv__UrMoverService_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, unity_ros_msgs, srv, UrMoverService_Request)() {
...
using _UrMoverService_Response__ros_msg_type = unity_ros_msgs__srv__UrMoverService_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_unity_ros_msgs
size_t get_serialized_size_unity_ros_msgs__srv__UrMoverService_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _UrMoverService_Response__ros_msg_type * ros_message = static_cast<const _UrMoverService_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_unity_ros_msgs__srv__UrMoverService_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_unity_ros_msgs
size_t max_serialized_size_unity_ros_msgs__srv__UrMoverService_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = unity_ros_msgs__srv__UrMoverService_Response;
    is_plain =
      (
...
static size_t _UrMoverService_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_unity_ros_msgs__srv__UrMoverService_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, unity_ros_msgs, srv, UrMoverService_Response)() {
...
// already included above
// #include "unity_ros_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "unity_ros_msgs/srv/ur_mover_service.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, unity_ros_msgs, srv, UrMoverService)() {
