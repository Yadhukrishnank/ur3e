...
bool unity_ros_msgs__msg__ur3e_trajectory__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("unity_ros_msgs.msg._ur3e_trajectory.UR3eTrajectory", full_classname_dest, 50) == 0);
  }
  unity_ros_msgs__msg__UR3eTrajectory * ros_message = _ros_message;
  {  // trajectory
...
PyObject * unity_ros_msgs__msg__ur3e_trajectory__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("unity_ros_msgs.msg._ur3e_trajectory");
