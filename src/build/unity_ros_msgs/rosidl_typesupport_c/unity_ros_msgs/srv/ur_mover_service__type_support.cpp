...
static const _UrMoverService_Request_type_support_symbol_names_t _UrMoverService_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, unity_ros_msgs, srv, UrMoverService_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, unity_ros_msgs, srv, UrMoverService_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, unity_ros_msgs, srv, UrMoverService_Request)() {
  return &::unity_ros_msgs::srv::rosidl_typesupport_c::UrMoverService_Request_message_type_support_handle;
}
...
static const _UrMoverService_Response_type_support_symbol_names_t _UrMoverService_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, unity_ros_msgs, srv, UrMoverService_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, unity_ros_msgs, srv, UrMoverService_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, unity_ros_msgs, srv, UrMoverService_Response)() {
  return &::unity_ros_msgs::srv::rosidl_typesupport_c::UrMoverService_Response_message_type_support_handle;
}
...
static const _UrMoverService_type_support_symbol_names_t _UrMoverService_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, unity_ros_msgs, srv, UrMoverService)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, unity_ros_msgs, srv, UrMoverService)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, unity_ros_msgs, srv, UrMoverService)() {
  return &::unity_ros_msgs::srv::rosidl_typesupport_c::UrMoverService_service_type_support_handle;
}
