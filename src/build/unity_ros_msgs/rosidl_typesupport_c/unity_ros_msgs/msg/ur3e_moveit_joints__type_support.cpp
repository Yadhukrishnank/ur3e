...
static const _UR3eMoveitJoints_type_support_symbol_names_t _UR3eMoveitJoints_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, unity_ros_msgs, msg, UR3eMoveitJoints)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, unity_ros_msgs, msg, UR3eMoveitJoints)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, unity_ros_msgs, msg, UR3eMoveitJoints)() {
  return &::unity_ros_msgs::msg::rosidl_typesupport_c::UR3eMoveitJoints_message_type_support_handle;
}
