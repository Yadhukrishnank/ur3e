...
static const _UR3eGripper_type_support_symbol_names_t _UR3eGripper_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, unity_ros_msgs, msg, UR3eGripper)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, unity_ros_msgs, msg, UR3eGripper)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, unity_ros_msgs, msg, UR3eGripper)() {
  return &::unity_ros_msgs::msg::rosidl_typesupport_c::UR3eGripper_message_type_support_handle;
}
