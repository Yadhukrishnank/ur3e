...
#include "unity_ros_msgs/msg/detail/ur3e_trajectory__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = unity_ros_msgs::msg::UR3eTrajectory;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const unity_ros_msgs::msg::UR3eTrajectory *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<unity_ros_msgs::msg::UR3eTrajectory *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _UR3eTrajectory__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const unity_ros_msgs::msg::UR3eTrajectory *>(
...
static size_t _UR3eTrajectory__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_UR3eTrajectory(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _UR3eTrajectory__callbacks = {
  "unity_ros_msgs::msg",
  "UR3eTrajectory",
...
static rosidl_message_type_support_t _UR3eTrajectory__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_UR3eTrajectory__callbacks,
...
{
  return &unity_ros_msgs::msg::typesupport_fastrtps_cpp::_UR3eTrajectory__handle;
}
