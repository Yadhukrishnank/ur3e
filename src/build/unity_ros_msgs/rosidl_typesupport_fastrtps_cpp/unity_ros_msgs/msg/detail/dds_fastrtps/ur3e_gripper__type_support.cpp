...
#include "unity_ros_msgs/msg/detail/ur3e_gripper__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const unity_ros_msgs::msg::UR3eGripper & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  unity_ros_msgs::msg::UR3eGripper & ros_message)
{
  // Member: gripper
  cdr >> ros_message.gripper;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = unity_ros_msgs::msg::UR3eGripper;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const unity_ros_msgs::msg::UR3eGripper *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<unity_ros_msgs::msg::UR3eGripper *>(
    untyped_ros_message);
...
{
  return &unity_ros_msgs::msg::typesupport_fastrtps_cpp::_UR3eGripper__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, unity_ros_msgs, msg, UR3eGripper)() {
  return &unity_ros_msgs::msg::typesupport_fastrtps_cpp::_UR3eGripper__handle;
}
