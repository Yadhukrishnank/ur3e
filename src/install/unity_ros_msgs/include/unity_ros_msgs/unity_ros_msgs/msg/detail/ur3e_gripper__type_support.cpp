...
{
  new (message_memory) unity_ros_msgs::msg::UR3eGripper(_init);
}

void UR3eGripper_fini_function(void * message_memory)
{
  auto typed_message = static_cast<unity_ros_msgs::msg::UR3eGripper *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember UR3eGripper_message_member_array[1] = {
  {
    ...
    offsetof(unity_ros_msgs::msg::UR3eGripper, gripper),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers UR3eGripper_message_members = {
  ...
  1,  // number of fields
  sizeof(unity_ros_msgs::msg::UR3eGripper),
...
{
  return &::unity_ros_msgs::msg::rosidl_typesupport_introspection_cpp::UR3eGripper_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, unity_ros_msgs, msg, UR3eGripper)() {
  return &::unity_ros_msgs::msg::rosidl_typesupport_introspection_cpp::UR3eGripper_message_type_support_handle;
}
