...
class Metaclass_UrMoverService_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from ur_robotiq.msg import UR3eMoveitJoints
...
class UrMoverService_Request(metaclass=Metaclass_UrMoverService_Request):
    ...
    _fields_and_field_types = {
        'joints_input': 'ur_robotiq/UR3eMoveitJoints',
        'pick_pose': 'geometry_msgs/Pose',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['ur_robotiq', 'msg'], 'UR3eMoveitJoints'),  # noqa: E501
...
class Metaclass_UrMoverService(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from ur_robotiq.srv import _ur_mover_service
...
class UrMoverService(metaclass=Metaclass_UrMoverService):
    from ur_robotiq.srv._ur_mover_service import UrMoverService_Request as Request
    from ur_robotiq.srv._ur_mover_service import UrMoverService_Response as Response
