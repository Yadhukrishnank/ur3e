...
class Metaclass_UR3eMoveitJoints(type):
    """Metaclass of message 'UR3eMoveitJoints'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('ur_robotiq')
        except ImportError:
            import logging
            import traceback
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__ur3e_moveit_joints
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__ur3e_moveit_joints
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__ur3e_moveit_joints
            cls._TYPE_SUPPORT = module.type_support_msg__msg__ur3e_moveit_joints
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__ur3e_moveit_joints
...
class UR3eMoveitJoints(metaclass=Metaclass_UR3eMoveitJoints):
    """Message class 'UR3eMoveitJoints'."""
