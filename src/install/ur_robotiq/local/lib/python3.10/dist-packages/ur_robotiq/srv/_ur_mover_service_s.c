...
bool ur_robotiq__msg__ur3e_moveit_joints__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool ur_robotiq__srv__ur_mover_service__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ur_robotiq.srv._ur_mover_service.UrMoverService_Request", full_classname_dest, 55) == 0);
  }
  ur_robotiq__srv__UrMoverService_Request * ros_message = _ros_message;
  {  // joints_input
    PyObject * field = PyObject_GetAttrString(_pymsg, "joints_input");
    if (!field) {
      return false;
    }
    if (!ur_robotiq__msg__ur3e_moveit_joints__convert_from_py(field, &ros_message->joints_input)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * ur_robotiq__srv__ur_mover_service__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ur_robotiq.srv._ur_mover_service");
  ...
  {  // joints_input
    PyObject * field = NULL;
    field = ur_robotiq__msg__ur3e_moveit_joints__convert_to_py(&ros_message->joints_input);
    if (!field) {
      return NULL;
    }
    {
...
ROSIDL_GENERATOR_C_EXPORT
bool ur_robotiq__srv__ur_mover_service__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ur_robotiq.srv._ur_mover_service.UrMoverService_Response", full_classname_dest, 56) == 0);
  }
  ur_robotiq__srv__UrMoverService_Response * ros_message = _ros_message;
  {  // trajectories
