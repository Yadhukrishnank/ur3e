...
bool ur_robotiq__msg__ur3e_gripper__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ur_robotiq.msg._ur3e_gripper.UR3eGripper", full_classname_dest, 40) == 0);
  }
  ur_robotiq__msg__UR3eGripper * ros_message = _ros_message;
  {  // gripper
...
PyObject * ur_robotiq__msg__ur3e_gripper__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ur_robotiq.msg._ur3e_gripper");
