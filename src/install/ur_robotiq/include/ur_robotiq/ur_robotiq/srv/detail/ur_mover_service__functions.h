...
#ifndef UR_ROBOTIQ__SRV__DETAIL__UR_MOVER_SERVICE__FUNCTIONS_H_
#define UR_ROBOTIQ__SRV__DETAIL__UR_MOVER_SERVICE__FUNCTIONS_H_
 ...
 * calls
 * ur_robotiq__srv__UrMoverService_Request__init().
...
/**
 * It calls
 * ur_robotiq__srv__UrMoverService_Request__fini()
 ...
 * ur_robotiq__srv__UrMoverService_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * ur_robotiq__srv__UrMoverService_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ur_robotiq__srv__UrMoverService_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ur_robotiq
...
/**
 * It calls
 * ur_robotiq__srv__UrMoverService_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ur_robotiq
...
/**
 * It allocates the memory for the array and calls
 * ur_robotiq__srv__UrMoverService_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ur_robotiq
...
/**
 * It calls
 * ur_robotiq__srv__UrMoverService_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // UR_ROBOTIQ__SRV__DETAIL__UR_MOVER_SERVICE__FUNCTIONS_H_
