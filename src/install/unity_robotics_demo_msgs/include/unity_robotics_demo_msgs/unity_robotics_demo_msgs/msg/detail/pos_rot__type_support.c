...
size_t unity_robotics_demo_msgs__msg__PosRot__rosidl_typesupport_introspection_c__size_function__PosRot__joints(
...
const void * unity_robotics_demo_msgs__msg__PosRot__rosidl_typesupport_introspection_c__get_const_function__PosRot__joints(
...
void * unity_robotics_demo_msgs__msg__PosRot__rosidl_typesupport_introspection_c__get_function__PosRot__joints(
...
void unity_robotics_demo_msgs__msg__PosRot__rosidl_typesupport_introspection_c__fetch_function__PosRot__joints(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const double * item =
    ((const double *)
    unity_robotics_demo_msgs__msg__PosRot__rosidl_typesupport_introspection_c__get_const_function__PosRot__joints(untyped_member, index));
  double * value =
    (double *)(untyped_value);
  *value = *item;
}

void unity_robotics_demo_msgs__msg__PosRot__rosidl_typesupport_introspection_c__assign_function__PosRot__joints(
  void * untyped_member, size_t index, const void * untyped_value)
{
  double * item =
    ((double *)
    unity_robotics_demo_msgs__msg__PosRot__rosidl_typesupport_introspection_c__get_function__PosRot__joints(untyped_member, index));
  const double * value =
    (const double *)(untyped_value);
  *item = *value;
}

static rosidl_typesupport_introspection_c__MessageMember unity_robotics_demo_msgs__msg__PosRot__rosidl_typesupport_introspection_c__PosRot_message_member_array[1] = {
  {
    "joints",  // name
    ...
    offsetof(unity_robotics_demo_msgs__msg__PosRot, joints),  // bytes offset in struct
    NULL,  // default value
    unity_robotics_demo_msgs__msg__PosRot__rosidl_typesupport_introspection_c__size_function__PosRot__joints,  // size() function pointer
    unity_robotics_demo_msgs__msg__PosRot__rosidl_typesupport_introspection_c__get_const_function__PosRot__joints,  // get_const(index) function pointer
    unity_robotics_demo_msgs__msg__PosRot__rosidl_typesupport_introspection_c__get_function__PosRot__joints,  // get(index) function pointer
    unity_robotics_demo_msgs__msg__PosRot__rosidl_typesupport_introspection_c__fetch_function__PosRot__joints,  // fetch(index, &value) function pointer
    unity_robotics_demo_msgs__msg__PosRot__rosidl_typesupport_introspection_c__assign_function__PosRot__joints,  // assign(index, value) function pointer
